...
namespace CBIM.AgentSystem.Kernel.Synapse
{
    ...
    public static class SynapseToolFactory
    {
        ...
        public static IReadOnlyList<AITool> Build(IReadOnlyList<Brain.Brain> callableBrains)
        {
        ...
        /// </summary>
        private static AIFunction BuildBrainCallFunction(Brain.Brain callable)
        {
        ...
        {
            private readonly Brain.Brain _callable;

            public BrainCallTrampoline(Brain.Brain callable)
            {
                _callable = callable;
            }
